<?php $currentUrl = $_SERVER['REQUEST_URI']; ?>
    <div class="sidebar sidebar-light sidebar-fixed bg-success" id="sidebar">
        ...
        <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
            <li class="nav-item">
                <a class="nav-link" href="/student/dashboard" <?php if($currentUrl == '/student/dashboard'){echo('style="background-color:yellow;color:black;"');} ?>>
                    <img class="nav-icon" src="views/vendors/@coreui/icons/svg/free/cil-speedometer.svg"/>
                    Dashboard
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/student/evaluate" <?php if($currentUrl == '/student/evaluate'){echo('style="background-color:yellow;color:black;"');} ?>>

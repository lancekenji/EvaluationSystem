        ...
        <div class="modal-content">
            <form id="manageProfileForm">
                ...
                <div class="modal-footer">
                    <input type="hidden" name="year_level" id="year_level" value="<?=$_SESSION['year_level']?>"/>
                    <input type="hidden" name="section_id" id="section_id" value="<?=$_SESSION['section_id']?>"/>
                    <input type="hidden" name="department_id" id="department_id" value="<?=$_SESSION['department_id']?>"/>
